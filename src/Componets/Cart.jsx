...
function Cart() {
  ...
  return (
    <>
     ...
     cartItems.length < 1 ? <div className="w-full h-screen flex justify-center items-center"><h1 className="text-3xl text-gray-950">Cart is empty</h1></div> : (
      cartItems.map((item) => (
        <section
          key={item.id}
            ...
            <div className="lg:w-4/5 mx-auto flex flex-wrap">
              ...
              <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                ...
                <div className="flex mt-6 items-center pb-5 border-b-2 border-gray-800 mb-5">
                  ...
                  <div className="flex ml-6 items-center">
                    <div className="relative flex items-center">
                      {/* <span className=""></span> */}
                      <Button
                        endIcon={<Delete color="error" fontSize="medium" />}
                ...
                <div className="flex">
                  ...
                  <button className="flex ml-auto text-white  border-0 py-2 px-6 focus:outline-none rounded">
                    {/* Button */}
                    <BasicModal totalPrice={totalPrice} totalQuantity = {totalQuantity}/>
                  </button>
